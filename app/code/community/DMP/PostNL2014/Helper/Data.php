 ...
 */
class DMP_PostNL2014_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     ...
     */
    const POSTNL_EXCEPTION_LOG_FILE = 'DMP_PostNL2014_Exception.log';

    /**
     * Log filename to log all non-specific PostNL debug messages.
     */
    const POSTNL_DEBUG_LOG_FILE = 'DMP_PostNL2014_Debug.log';
     ...
     *
     * @return false|Mage_Sales_Model_Order_Address|Mage_Sales_Model_Quote_Address|DMP_PostNL2014_Model_Shipment
     */
    public function getPgAddress($object)
    {
        ...
        } elseif ($object instanceof DMP_PostNL2014_Model_Shipment) {
    ...
    public function getStreetData($address, $throwException = true)
    {
         ...
         * @var DMP_PostNL2014_Helper_Data $this
         */
    ...
    public function sendBarcodeEmail($barcode = '', $postNLShipment)
    {
        ...
        if (!$postNLShipment instanceof DMP_PostNL2014_Model_Shipment) {
            return false;
        }
