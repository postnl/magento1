 ...
 */
class DMP_PostNL2014_Block_Adminhtml_Sales_Order_View_ShippingInfo extends Mage_Adminhtml_Block_Abstract
{
    /**
     * @var Mage_Sales_Model_Order|DMP_PostNL2014_Model_Sales_Order
     */
    protected $_order;

    /**
     * @var DMP_PostNL2014_Helper_Data
     */
    protected $_helper;
    ...
    {
        $optionsHtml = '';
        /** @var $postNLShipment DMP_PostNL2014_Model_Shipment */
