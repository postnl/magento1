 ...
 */
class DMP_PostNL2014_CheckoutController extends Mage_Core_Controller_Front_Action
{
    const CC_BE = 'BE';
    const CC_NL = 'NL';
    ...
    {
        /** @var DMP_PostNL2014_Helper_AddressValidation $helper */
        ...
        $info = array(
            'version' => (string) Mage::getConfig()->getModuleConfig("DMP_PostNL2014")->version,
            'data' => (object)$data
        );
    ...
    {
        $cronController = new DMP_PostNL2014_Model_Observer_Cron;
