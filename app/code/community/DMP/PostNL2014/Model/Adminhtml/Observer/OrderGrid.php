 ...
 *
 * @method DMP_PostNL2014_Model_Adminhtml_Observer_OrderGrid   setCollection(DMP_PostNL2014_Model_Resource_Order_Grid_Collection $value)
 * @method DMP_PostNL2014_Model_Resource_Order_Grid_Collection getCollection()
 * @method DMP_PostNL2014_Model_Adminhtml_Observer_OrderGrid   setBlock(Mage_Adminhtml_Block_Sales_Order_Grid $value)
 * @method Mage_Adminhtml_Block_Sales_Order_Grid                 getBlock()
 */
class DMP_PostNL2014_Model_Adminhtml_Observer_OrderGrid extends Varien_Object
{
    /**
     ...
     *
     * @observer dmp_postnl_adminhtml_ordergrid
     */
    public function modifyGrid(Varien_Event_Observer $observer)
    {
         ...
         */
        $collection = Mage::getResourceModel('dmp_postnl/order_grid_collection');
        ...
        if ($useFilter) {
            $block->addColumnAfter(
                ...
                array(
                    ...
                    'sortable' => false,
                    'renderer' => 'dmp_postnl/adminhtml_widget_grid_column_renderer_shippingStatus',
                    'type' => 'options',
                    'options' => array(
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var DMP_PostNL2014_Model_Resource_Order_Grid_Collection $collection
             */
