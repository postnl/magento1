 ...
 *
 * @method DMP_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid   setCollection(DMP_PostNL2014_Model_Resource_Shipment_Grid_Collection $value)
 * @method DMP_PostNL2014_Model_Resource_Shipment_Grid_Collection getCollection()
 * @method DMP_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid   setBlock(Mage_Adminhtml_Block_Sales_Shipment_Grid $block)
 * @method Mage_Adminhtml_Block_Sales_Shipment_Grid             getBlock()
 */
class DMP_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid extends Varien_Object
{
    /**
     ...
     *
     * @observer dmp_postnl_adminhtml_shipmentgrid
     */
    public function modifyGrid(Varien_Event_Observer $observer)
    {
         ...
         */
        $collection = Mage::getResourceModel('dmp_postnl/shipment_grid_collection');
     ...
     *
     * @param DMP_PostNL2014_Model_Resource_Shipment_Grid_Collection $collection
     *
     * @return $this
     */
    protected function _joinCollection($collection)
    {
        ...
        /**
         * Join dmp_postnl_shipment table.
         */
        $select->joinLeft(
            array('dmp_postnl_shipment' => $resource->getTableName('dmp_postnl/shipment')),
            'main_table.entity_id=dmp_postnl_shipment.shipment_id',
            array('status' => 'dmp_postnl_shipment.status', 'barcode' => 'dmp_postnl_shipment.barcode')
        );
    ...
    protected function _addColumns($block)
    {
        ...
        $block->addColumnAfter(
            ...
            array(
                ...
                'sortable'       => false,
                'filter'         => false,
                'renderer'       => 'dmp_postnl/adminhtml_widget_grid_column_renderer_shipment_shippingStatus',
            ),
            'shipping_name'
        );
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var DMP_PostNL2014_Model_Resource_Shipment_Grid_Collection $collection
             */
        ...
        $block->getMassactionBlock()
            ->addItem(
                ...
                array(
                    ...
                    'url'   => $adminhtmlHelper->getUrl('adminhtml/postnlAdminhtml_shipment/massPrintShipmentLabels'),
                    'additional' => array(
                        'type_consignment' => array(
                            'name'    => 'type_consignment',
                            'type'    => 'select',
                            'options' => array(
                                DMP_PostNL2014_Model_Shipment::TYPE_NORMAL     => $helper->__('Normal'),
                                DMP_PostNL2014_Model_Shipment::TYPE_LETTER_BOX => $helper->__('Letterbox'),
                                DMP_PostNL2014_Model_Shipment::TYPE_UNPAID     => $helper->__('Unpaid'),
                            ),
                        ),
