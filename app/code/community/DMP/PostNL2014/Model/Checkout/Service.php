 ...
 */
class DMP_PostNL2014_Model_Checkout_Service
{
    /**
    ...
    public function savePostNLShippingMethod()
    {
        ...
        if($request->isPost()){
            ...
            $addressHelper = Mage::helper('dmp_postnl/addressValidation');
        ...
        if ($quote) {
            if ($quote != '{}') {
                ...
                foreach ($addresses as $address) {
                    if ($address->getAddressType() == DMP_PostNL2014_Helper_Data::PG_ADDRESS_TYPE) {
                        $address->delete();
                    }
                }
            }
