 ...
 */
class DMP_PostNL2014_Model_Api_PostNL extends Varien_Object
{
    /**
    ...
    protected function _getUserAgent()
    {
        ...
        $userAgents = [
            ...
            'PostNL-Magento/'. (string) Mage::getConfig()->getModuleConfig("DMP_PostNL2014")->version
        ];
    ...
    public function sendRequest($method = 'POST', $checkConfig = true)
    {
        ...
        $request = new DMP_PostNL2014_Model_Api_Curl();
        //add the options
     ...
     *
     * @param DMP_PostNL2014_Model_Shipment $postNLShipment
     *
     * @return $this
     */
    public function createConsignmentRequest(DMP_PostNL2014_Model_Shipment $postNLShipment)
    {
    ...
    public function createRegisterConfigRequest()
    {
        $data = array(
            ...
            'plugin_version'  => (string) Mage::getConfig()->getModuleConfig('DMP_PostNL2014')->version,
     ...
     * @throws DMP_PostNL2014_Exception
     */
    protected function _getConsignmentData(DMP_PostNL2014_Model_Shipment $postNLShipment)
    {
    ...
    public function getSecondaryShipmentsData(DMP_PostNL2014_Model_Shipment $postNLShipment, $countryCode){
     ...
     * @return array
     */
    protected function _getOptionsData(DMP_PostNL2014_Model_Shipment $postNLShipment, $checkoutData, $countryCode)
    {
        /**
         * @var DMP_PostNL2014_Helper_Data $helper
         */
     ...
     * @return int
     */
    protected function _getInsuredAmount(DMP_PostNL2014_Model_Shipment $postNLShipment)
    {
