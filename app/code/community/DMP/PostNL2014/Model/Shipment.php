 ...
 * @method int    getIsXL()
 *
 * @method DMP_PostNL2014_Model_Shipment setShipmentId(int $value)
 * @method DMP_PostNL2014_Model_Shipment setOrderId(int $value)
 * @method DMP_PostNL2014_Model_Shipment setTrackId(int $value)
 * @method DMP_PostNL2014_Model_Shipment setConsignmentId(int $value)
 * @method DMP_PostNL2014_Model_Shipment setCreatedAt(string $value)
 * @method DMP_PostNL2014_Model_Shipment setUpdatedAt(string $value)
 * @method DMP_PostNL2014_Model_Shipment setStatus(string $value)
 * @method DMP_PostNL2014_Model_Shipment setBarcode(string $value)
 * @method DMP_PostNL2014_Model_Shipment setIsFinal(int $value)
 * @method DMP_PostNL2014_Model_Shipment setShipment(Mage_Sales_Model_Order_Shipment $value)
 * @method DMP_PostNL2014_Model_Shipment setOrder(Mage_Sales_Model_Order $value)
 * @method DMP_PostNL2014_Model_Shipment setShippingAddress(Mage_Sales_Model_Order_Address $value)
 * @method DMP_PostNL2014_Model_Shipment setApi(DMP_PostNL2014_Model_Api_PostNL $value)
 * @method DMP_PostNL2014_Model_Shipment setShipmentIncrementId(string $value)
 * @method DMP_PostNL2014_Model_Shipment setBarcodeSend(int $value)
 * @method DMP_PostNL2014_Model_Shipment setRetourlink(string $value)
 * @method DMP_PostNL2014_Model_Shipment setIsCredit(int $value)
 * @method DMP_PostNL2014_Model_Shipment setCustomsContentType(int $value)
 * @method DMP_PostNL2014_Model_Shipment setShipmentType(string $value)
 * @method DMP_PostNL2014_Model_Shipment setIsXl(int $value)
 *
 */
class DMP_PostNL2014_Model_Shipment extends Mage_Core_Model_Abstract
{
    /**
     ...
     *
     * @return DMP_PostNL2014_Model_Api_PostNL
     */
