 ...
 *
 * @method DMP_PostNL_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setShipment(Mage_Sales_Model_Order_Shipment $value)
 * @method DMP_PostNL_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setShipmentBaseGrandTotal(float $value)
 * @method DMP_PostNL_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setDestinationCountry(string $value)
 *
 */
class DMP_PostNL_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions extends Mage_Adminhtml_Block_Abstract
{
    /**
    ...
    public function hasExtraOptions()
    {
         ...
         * @var \DMP_PostNL_Model_Shipment $shipment
         */
        $helper   = Mage::helper('dmp_postnl');
        $shipment = Mage::registry('current_shipment');
