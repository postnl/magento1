 ...
 *
 * @method DMP_PostNL_Model_Adminhtml_Observer_OrderGrid   setCollection(DMP_PostNL_Model_Resource_Order_Grid_Collection $value)
 * @method DMP_PostNL_Model_Resource_Order_Grid_Collection getCollection()
 * @method DMP_PostNL_Model_Adminhtml_Observer_OrderGrid   setBlock(Mage_Adminhtml_Block_Sales_Order_Grid $value)
 * @method Mage_Adminhtml_Block_Sales_Order_Grid                 getBlock()
 */
class DMP_PostNL_Model_Adminhtml_Observer_OrderGrid extends Varien_Object
{
    /**
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var DMP_PostNL_Model_Resource_Order_Grid_Collection $collection
             */
