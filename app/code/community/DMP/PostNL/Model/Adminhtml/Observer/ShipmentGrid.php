 ...
 *
 * @method DMP_PostNL_Model_Adminhtml_Observer_ShipmentGrid   setCollection(DMP_PostNL_Model_Resource_Shipment_Grid_Collection $value)
 * @method DMP_PostNL_Model_Resource_Shipment_Grid_Collection getCollection()
 * @method DMP_PostNL_Model_Adminhtml_Observer_ShipmentGrid   setBlock(Mage_Adminhtml_Block_Sales_Shipment_Grid $block)
 * @method Mage_Adminhtml_Block_Sales_Shipment_Grid             getBlock()
 */
class DMP_PostNL_Model_Adminhtml_Observer_ShipmentGrid extends Varien_Object
{
    /**
     ...
     *
     * @param DMP_PostNL_Model_Resource_Shipment_Grid_Collection $collection
     *
     * @return $this
     */
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var DMP_PostNL_Model_Resource_Shipment_Grid_Collection $collection
             */
