 ...
 */
class DMP_PostNL_PostnlAdminhtml_ShipmentController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Used module name in current adminhtml controller.
     */
    protected $_usedModuleName = 'DMP_PostNL';
    ...
    public function massPrintLabelsAction()
    {
        ...
        /**
         * @var $api DMP_PostNL_Model_Api_PostNL
         */
     ...
     *                                         Mage_Sales_Model_Shipment or DMP_PostNL_Model_Shipment objects.
    ...
    protected function _loadAndCheckShipments($shipmentIds, $loadPostNLShipments = false, $throwException = true, $keyIsConsignmentId = true)
    {
        ...
        foreach ($shipmentIds as $shipmentId) {
             ...
             * Load the shipment.
             *
             * @var Mage_Sales_Model_Order_Shipment|DMP_PostNL_Model_Shipment|boolean $shipment
             */
     ...
     *
     * @return boolean|Mage_Sales_Model_Order_Shipment|DMP_PostNL_Model_Shipment
     */
     ...
     * @param int $shipmentId
     *
     * @return DMP_PostNL_Model_Shipment
     */
     ...
     *
     * @return int|DMP_PostNL_Exception
     *
     *
     * @throws DMP_PostNL_Exception
     */
