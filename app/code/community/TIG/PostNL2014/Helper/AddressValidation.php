 ...
 */
class TIG_PostNL2014_Helper_AddressValidation extends TIG_PostNL2014_Helper_Data
{
    /**
     * Constants containing XML paths to cif address configuration options
     */
    const XPATH_SPLIT_STREET                = 'tig_postnl/shipment/split_street';
    const XPATH_STREETNAME_FIELD            = 'tig_postnl/shipment/streetname_field';
    const XPATH_HOUSENUMBER_FIELD           = 'tig_postnl/shipment/housenr_field';
    const XPATH_SPLIT_HOUSENUMBER           = 'tig_postnl/shipment/split_housenr';
    const XPATH_HOUSENUMBER_EXTENSION_FIELD = 'tig_postnl/shipment/housenr_extension_field';
