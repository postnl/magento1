 ...
 */
class TIG_PostNL2014_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     ...
     */
    const POSTNL_EXCEPTION_LOG_FILE = 'TIG_PostNL2014_Exception.log';

    /**
     * Log filename to log all non-specific PostNL debug messages.
     */
    const POSTNL_DEBUG_LOG_FILE = 'TIG_PostNL2014_Debug.log';
    ...
    public function getConfig($value, $group = 'general', $storeId = null, $decrypt = false)
    {
        ...
        $config = Mage::getStoreConfig('tig_postnl/' . $group . '/' . $value, $storeId);
     ...
     *
     * @return false|Mage_Sales_Model_Order_Address|Mage_Sales_Model_Quote_Address|TIG_PostNL2014_Model_Shipment
     */
    public function getPgAddress($object)
    {
        ...
        } elseif ($object instanceof TIG_PostNL2014_Model_Shipment) {
    ...
    public function shippingHasExtraOptions($method)
    {
        ...
        $postNLCarrier = Mage::getModel('tig_postnl/carrier_postNL');
     ...
     *
     * @param TIG_PostNL2014_Model_Shipment $postNLShipment
     *
     * @return string
     */
    ...
    public function getStreetData($address, $throwException = true)
    {
         ...
         * @var TIG_PostNL2014_Helper_Data $this
         */
    ...
    public function sendBarcodeEmail($barcode = '', $postNLShipment)
    {
        ...
        if (!$postNLShipment instanceof TIG_PostNL2014_Model_Shipment) {
            return false;
        }
        ...
        if ($templateId === null || $templateId == 'tig_postnl_general_tracktrace_template') {
            return false;
        }
    ...
    {
        $aConfig = Mage::getStoreConfig('tig_postnl/' . $shippingMethod, Mage::app()->getStore());
