 ...
 *
 * @method TIG_PostNL2014_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setShipment(Mage_Sales_Model_Order_Shipment $value)
 * @method TIG_PostNL2014_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setShipmentBaseGrandTotal(float $value)
 * @method TIG_PostNL2014_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions setDestinationCountry(string $value)
 *
 */
class TIG_PostNL2014_Block_Adminhtml_Sales_Order_Shipment_Create_ConsignmentOptions extends Mage_Adminhtml_Block_Abstract
{
    /**
    ...
    protected function _toHtml()
    {
        ...
        if (!$shipment
            || !$helper->shippingMethodIsPostNL($shipment->getOrder()->getShippingMethod())
    ...
    {
        return Mage::getModel('tig_postnl/system_config_source_customs')->toOptionArray();
    }
