 ...
 */
class TIG_PostNL2014_Block_Adminhtml_Sales_Order_Shipment_ShippingInfo extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    /**
     * @var TIG_PostNL2014_Model_Shipment
     */
    ...
    public function __construct()
    {
        ...
        $this->_postNLShipment = Mage::getModel('tig_postnl/shipment')->load($shipmentId, 'shipment_id');
    }
    ...
    {
        $res = array();
        $pgAddress = Mage::helper('tig_postnl')->getPgAddress($this->_shipment->getOrder());
