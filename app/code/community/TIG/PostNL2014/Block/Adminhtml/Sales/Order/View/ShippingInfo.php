 ...
 */
class TIG_PostNL2014_Block_Adminhtml_Sales_Order_View_ShippingInfo extends Mage_Adminhtml_Block_Abstract
{
    /**
     * @var Mage_Sales_Model_Order|TIG_PostNL2014_Model_Sales_Order
     */
    protected $_order;

    /**
     * @var TIG_PostNL2014_Helper_Data
     */
    protected $_helper;
    ...
    public function __construct()
    {
        ...
        $this->_helper = Mage::helper('tig_postnl');

        $this->_postNLShipments = Mage::getModel('tig_postnl/shipment')
            ->getCollection()
    ...
    {
        $optionsHtml = '';
        /** @var $postNLShipment TIG_PostNL2014_Model_Shipment */
