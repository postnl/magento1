 ...
 * @method TIG_PostNL2014_Model_Observer_SavePgAddress setQuote(Mage_Sales_Model_Quote $quote)
 */
class TIG_PostNL2014_Model_Observer_SavePgAddress extends Varien_Object
{
    /**
     ...
     *
     * @observer tig_postnl_copy_pg_address
     */
    public function copyAddressToOrder(Varien_Event_Observer $observer)
    {
        ...
        if($postNLData === null || !key_exists('location', $postNLData) || !$pakjeGemakAddress){
            Mage::getModel('tig_postnl/checkout_service')->removePgAddress($quote);
            return $this;
        }

        Mage::getModel('tig_postnl/checkout_service')->copyAddressToOrder($order, $pakjeGemakAddress);
        return $this;
    }
