 ...
 * @method int    getIsXL()
 *
 * @method TIG_PostNL2014_Model_Shipment setShipmentId(int $value)
 * @method TIG_PostNL2014_Model_Shipment setOrderId(int $value)
 * @method TIG_PostNL2014_Model_Shipment setTrackId(int $value)
 * @method TIG_PostNL2014_Model_Shipment setConsignmentId(int $value)
 * @method TIG_PostNL2014_Model_Shipment setCreatedAt(string $value)
 * @method TIG_PostNL2014_Model_Shipment setUpdatedAt(string $value)
 * @method TIG_PostNL2014_Model_Shipment setStatus(string $value)
 * @method TIG_PostNL2014_Model_Shipment setBarcode(string $value)
 * @method TIG_PostNL2014_Model_Shipment setIsFinal(int $value)
 * @method TIG_PostNL2014_Model_Shipment setShipment(Mage_Sales_Model_Order_Shipment $value)
 * @method TIG_PostNL2014_Model_Shipment setOrder(Mage_Sales_Model_Order $value)
 * @method TIG_PostNL2014_Model_Shipment setShippingAddress(Mage_Sales_Model_Order_Address $value)
 * @method TIG_PostNL2014_Model_Shipment setApi(TIG_PostNL2014_Model_Api_PostNL $value)
 * @method TIG_PostNL2014_Model_Shipment setShipmentIncrementId(string $value)
 * @method TIG_PostNL2014_Model_Shipment setBarcodeSend(int $value)
 * @method TIG_PostNL2014_Model_Shipment setRetourlink(string $value)
 * @method TIG_PostNL2014_Model_Shipment setIsCredit(int $value)
 * @method TIG_PostNL2014_Model_Shipment setCustomsContentType(int $value)
 * @method TIG_PostNL2014_Model_Shipment setShipmentType(string $value)
 * @method TIG_PostNL2014_Model_Shipment setIsXl(int $value)
 *
 */
class TIG_PostNL2014_Model_Shipment extends Mage_Core_Model_Abstract
{
    /**
    ...
    {
        $this->_init('tig_postnl/shipment');
        $this->helper = Mage::helper('tig_postnl');
    }
     ...
     *
     * @return TIG_PostNL2014_Model_Api_PostNL
     */
    public function getApi()
    {
        ...
        $api     = Mage::getModel('tig_postnl/api_postNL',array('store_id' => $storeId));
    ...
    public function setConsignmentOptions($consignmentOptions = array())
    {
         ...
         */
        $filteredOptions = $registryOptions = Mage::registry('tig_postnl_consignment_options');
     ...
     * @returns $this
     *
     * @throws TIG_PostNL2014_Exception
     */
    public function createConsignment()
    {
         ...
         *
         * @var TIG_PostNL2014_Model_Api_PostNL $api
         */
        $api = $this->getApi();
