 ...
 */
class TIG_PostNL2014_Model_Api_PostNL extends Varien_Object
{
    /**
    ...
    protected function _construct()
    {
        ...
        if (Mage::app()->getStore()->isCurrentlySecure()) {
            if(!Mage::getStoreConfig('tig_postnl/general/ssl_handshake')){
    ...
    protected function _getUserAgent()
    {
        ...
        $userAgents = [
            ...
            'PostNL-Magento/'. (string) Mage::getConfig()->getModuleConfig("TIG_PostNL2014")->version
        ];
    ...
    public function sendRequest($method = 'POST', $checkConfig = true)
    {
        ...
        $request = new TIG_PostNL2014_Model_Api_Curl();
        //add the options
     ...
     * @return $this
     */
    public function createConsignmentRequest(TIG_PostNL2014_Model_Shipment $postNLShipment)
    {
    ...
    public function createRegisterConfigRequest()
    {
        $data = array(
            ...
            'plugin_version'  => (string) Mage::getConfig()->getModuleConfig('TIG_PostNL2014')->version,
     ...
     * @throws TIG_PostNL2014_Exception
     */
    protected function _getConsignmentData(TIG_PostNL2014_Model_Shipment $postNLShipment)
    {
     ...
     * @return int
     */
    protected function _getInsuredAmount(TIG_PostNL2014_Model_Shipment $postNLShipment)
    {
