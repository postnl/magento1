 ...
 */
    if (file_exists(Mage::getBaseDir() . '/app/code/community/MDN/AdvancedStock/Model/Sales/Order.php') && class_exists('MDN_AdvancedStock_Model_Sales_Order')) {
        class TIG_PostNL2014_Model_Sales_Order_OverrideCheck extends MDN_AdvancedStock_Model_Sales_Order { }
        ...
        class TIG_PostNL2014_Model_Sales_Order_OverrideCheck extends Emagicone_Mobassistantconnector_Model_Order { }
    } else {
        class TIG_PostNL2014_Model_Sales_Order_OverrideCheck extends Mage_Sales_Model_Order { }
    }

    class TIG_PostNL2014_Model_Sales_Order extends TIG_PostNL2014_Model_Sales_Order_OverrideCheck
    {
