...
class TIG_PostNL2014_Model_Type_Onepage extends Mage_Checkout_Model_Type_Onepage
{
    ...
    public function saveShippingMethod($shippingMethod)
    {
        ...
        if(Mage::getModel('tig_postnl/checkout_service')->savePostNLShippingMethod() != true) {
