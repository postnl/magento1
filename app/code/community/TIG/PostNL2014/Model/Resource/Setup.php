 ...
 */
class TIG_PostNL2014_Model_Resource_Setup extends Mage_Catalog_Model_Resource_Setup
{
    /**
     * Cron expression and cron model definitions for statistics update cron
     */
    const UPDATE_STATISTICS_CRON_STRING_PATH = 'crontab/jobs/tig_postnl_check_status/schedule/cron_expr';
    const UPDATE_STATISTICS_CRON_MODEL_PATH  = 'crontab/jobs/tig_postnl_check_status/run/model';
    ...
    public function generateCheckStatusExpr()
    {
        ...
        try {
            ...
            throw new TIG_PostNL2014_Exception(
                Mage::helper('tig_postnl')->__('Unable to save check_status cron expression: %s', $cronExpr),
                'MYPA-0022',
                $e
            );
        }
        ...
        try {
            ...
            foreach ($result as $row) {
                try {
                    ...
                    Mage::helper('tig_postnl')->logException($e);
                }
            }
        } catch (Exception $e) {
            Mage::helper('tig_postnl')->logException($e);
