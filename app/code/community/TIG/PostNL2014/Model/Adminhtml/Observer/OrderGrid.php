 ...
 *
 * @method TIG_PostNL2014_Model_Adminhtml_Observer_OrderGrid   setCollection(TIG_PostNL2014_Model_Resource_Order_Grid_Collection $value)
 * @method TIG_PostNL2014_Model_Resource_Order_Grid_Collection getCollection()
 * @method TIG_PostNL2014_Model_Adminhtml_Observer_OrderGrid   setBlock(Mage_Adminhtml_Block_Sales_Order_Grid $value)
 * @method Mage_Adminhtml_Block_Sales_Order_Grid                 getBlock()
 */
class TIG_PostNL2014_Model_Adminhtml_Observer_OrderGrid extends Varien_Object
{
    /**
     ...
     *
     * @observer tig_postnl_adminhtml_ordergrid
     */
    public function modifyGrid(Varien_Event_Observer $observer)
    {
         ...
         */
        $collection = Mage::getResourceModel('tig_postnl/order_grid_collection');
        ...
        if ($useFilter) {
            $block->addColumnAfter(
                ...
                array(
                    ...
                    'sortable' => false,
                    'renderer' => 'tig_postnl/adminhtml_widget_grid_column_renderer_shippingStatus',
                    'type' => 'options',
                    'options' => array(
        ...
        if (isset($value)) {
            ...
            if($date){
                $this->getCollection()->getSelect()->where(
                    "main_table.postnl_send_date " . $sqlDate
                );
            }
        }
    ...
    protected function _addMassaction($block)
    {
        ...
        $block->getMassactionBlock()
            ->addItem(
                'postnl_print_labels',
                array(
                    'label' => $helper->__('PostNL - Create labels'),
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var TIG_PostNL2014_Model_Resource_Order_Grid_Collection $collection
             */
