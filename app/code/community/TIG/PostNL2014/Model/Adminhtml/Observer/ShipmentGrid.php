 ...
 *
 * @method TIG_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid   setCollection(TIG_PostNL2014_Model_Resource_Shipment_Grid_Collection $value)
 * @method TIG_PostNL2014_Model_Resource_Shipment_Grid_Collection getCollection()
 * @method TIG_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid   setBlock(Mage_Adminhtml_Block_Sales_Shipment_Grid $block)
 * @method Mage_Adminhtml_Block_Sales_Shipment_Grid             getBlock()
 */
class TIG_PostNL2014_Model_Adminhtml_Observer_ShipmentGrid extends Varien_Object
{
    /**
     ...
     *
     * @observer tig_postnl_adminhtml_shipmentgrid
     */
    public function modifyGrid(Varien_Event_Observer $observer)
    {
         ...
         */
        $collection = Mage::getResourceModel('tig_postnl/shipment_grid_collection');
     ...
     *
     * @param TIG_PostNL2014_Model_Resource_Shipment_Grid_Collection $collection
     *
     * @return $this
     */
    protected function _joinCollection($collection)
    {
         ...
         */
        $select->joinLeft(
            array('tig_postnl_shipment' => $resource->getTableName('tig_postnl/shipment')),
            'main_table.entity_id=tig_postnl_shipment.shipment_id',
            array('status' => 'tig_postnl_shipment.status', 'barcode' => 'tig_postnl_shipment.barcode')
        );
    ...
    protected function _addColumns($block)
    {
        ...
        $block->addColumnAfter(
            ...
            array(
                ...
                'sortable'       => false,
                'filter'         => false,
                'renderer'       => 'tig_postnl/adminhtml_widget_grid_column_renderer_shipment_shippingStatus',
            ),
            'shipping_name'
        );
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var TIG_PostNL2014_Model_Resource_Shipment_Grid_Collection $collection
             */
                ...
                array(
                    ...
                    'additional' => array(
                        'type_consignment' => array(
                            ...
                            'type'    => 'select',
                            'options' => array(
                                TIG_PostNL2014_Model_Shipment::TYPE_NORMAL     => $helper->__('Normal'),
                                TIG_PostNL2014_Model_Shipment::TYPE_LETTER_BOX => $helper->__('Letterbox'),
                                TIG_PostNL2014_Model_Shipment::TYPE_UNPAID     => $helper->__('Unpaid'),
                            ),
                        ),
